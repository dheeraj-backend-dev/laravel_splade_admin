...
class Users extends AbstractTable
{
    ...
    public function for()
    {
        ...
        ->allowedFilters(['id', 'username', 'first_name', 'last_name', 'email', 'created_at', $globalSearch]);
    }
    ...
    $table
            ...
            ->column('id', sortable: true)
            ->column('username', sortable: true, hidden:true)
            ...
            //     return route('admin.users.edit', $user);    // use this without show Link or button
            // })
            ->column('action')
            ->paginate(15);
    }
